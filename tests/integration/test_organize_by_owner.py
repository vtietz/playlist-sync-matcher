...
def test_organize_by_owner_structure():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert (
            export_dir / "my_playlists" / "My Playlist_pl1.m3u"
        ).exists(), "User's playlist should be in my_playlists folder"
        ...
        assert (
            export_dir / "other" / "Unknown Playlist_pl3.m3u"
        ).exists(), "Unknown owner playlist should be in 'other' folder"
