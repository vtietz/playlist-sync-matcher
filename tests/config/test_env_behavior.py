...
class TestEnvironmentOverrides:
    ...
    def test_env_file_loading(self, tmp_path, monkeypatch):
        """Test .env file loading with SPX_ENABLE_DOTENV enabled."""
    ...
    def test_boolean_coercion(self, monkeypatch, env_value, expected):
        ...
        monkeypatch.setenv('SPX__LIBRARY__SKIP_UNCHANGED', env_value)
        cfg = load_config()
    ...
    def test_integer_coercion(self, monkeypatch, env_value, expected):
        ...
        monkeypatch.setenv('SPX__LIBRARY__COMMIT_INTERVAL', env_value)
        cfg = load_config()
    ...
    def test_float_coercion(self, monkeypatch, env_value, expected):
        ...
        monkeypatch.setenv('SPX__MATCHING__FUZZY_THRESHOLD', env_value)
        cfg = load_config()
