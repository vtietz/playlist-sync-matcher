...
def is_completion_marker(line: str) -> bool:
    ...
    """
    return bool(
        PATTERNS["completion"].search(line)
        or PATTERNS["completion_export"].search(line)
        or PATTERNS["completion_incremental"].search(line)
        or PATTERNS["completion_sync"].search(line)
        or PATTERNS["completion_matched"].search(line)
        or PATTERNS["completion_created"].search(line)
    )
