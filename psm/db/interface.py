...
class DatabaseInterface(ABC):
    ...
    @abstractmethod
    def get_playlist_by_id(self, playlist_id: str, provider: str | None = None) -> Optional[SupportsRowMapping]: ...

    @abstractmethod
    def get_all_playlists(self, provider: str | None = None) -> List[SupportsRowMapping]: ...
