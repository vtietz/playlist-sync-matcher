...
- Configuration option for default propagate behavior
- Metadata-based duplicate detection (when ISRC unavailable)
- Bulk manual matching interface for many tracks
...
**Status:** This release is currently in development. Features and details may change before final release.
